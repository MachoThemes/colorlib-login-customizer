...
class Colorlib_Login_Customizer_CSS_Customization {
	...
	public function set_options() {
		...
		$this->selectors = array(
			...
			'#loginform,#registerform,#lostpasswordform,#resetpassform' => array(
				'attributes' => array(
					'height',
					'background-image',
					'background-color',
